...
DEFAULT_COMPETITOR_STRUCTURE = [
    {
        "mapping_code": "COMP_SET",
        "mapping_name": "Competitive Set",
        "category_code": "PRIMARY",
        "category_name": "Primary Competitors",
        "group_code": "COMP",
        "group_name": "Competitors",
    },
    {
        "mapping_code": "ASP_SET",
        "mapping_name": "Aspirational Competitor",
        "category_code": "SECONDARY",
        "category_name": "Secondary Competitors",
        "group_code": "COMP",
        "group_name": "Competitors",
    },
    {
        "mapping_code": "ALT_SET",
        "mapping_name": "Alternative Competitor",
        "category_code": "SECONDARY",
        "category_name": "Secondary Competitors",
        "group_code": "COMP",
        "group_name": "Competitors",
    ...
    {
        "mapping_code": "LOCAL_SET",
        "mapping_name": "Local Competitor",
        "category_code": "MARKET",
        "category_name": "Market Competitors",
        "group_code": "COMP",
        "group_name": "Competitors",
    },
]
...
def get_default_competitor_structure():
    return list(DEFAULT_COMPETITOR_STRUCTURE)


@transaction.atomic
def seed_default_competitors_for_property(property_obj, actor=None):
    structure = get_default_competitor_structure()
    ...
    for group_index, (group_code, group_name) in enumerate(unique_groups, start=1):
        group, _ = CompetitorGroup.objects.get_or_create(
    ...
    for category_index, (category_code, category_name, group_code) in enumerate(unique_categories, start=1):
        ...
        category, _ = CompetitorCategory.objects.get_or_create(
            property=property_obj,
            code=category_code,
            defaults={
                "name": category_name,
    ...
    for mapping_index, row in enumerate(structure, start=1):
        ...
        mapping, _ = CompetitorMapping.objects.get_or_create(
            property=property_obj,
